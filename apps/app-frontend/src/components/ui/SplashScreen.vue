	...
	<Transition name="splash-fade" @after-leave="onAfterLeave">
		<div v-if="!doneLoading" class="splash-screen dark">
			<div class="app-logo-wrapper" data-tauri-drag-region>
				<div class="app-logo">
					<img src="@/assets/branding/sleepless-launcher-logo.png" alt="" class="app-logo-mark" />
					<span class="app-logo-wordmark">Sleepless Launcher</span>
				</div>
...
.gradient-bg {
	...
	width: 100vw;
	background:
		linear-gradient(180deg, rgba(80, 80, 80, 0.275) 0%, rgba(17, 35, 43, 0.5) 97.29%),
