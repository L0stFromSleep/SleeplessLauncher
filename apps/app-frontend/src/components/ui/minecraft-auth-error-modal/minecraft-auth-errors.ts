...
export const minecraftAuthErrors: MinecraftAuthError[] = [
	{
		...
		whatHappened:
			'Your saved Microsoft sign-in token has expired or was revoked, so Sleepless Launcher cannot refresh your Minecraft session.',
		stepsToFix: [
			'Sign out of the affected Minecraft account in Sleepless Launcher',
	...
	},
	{
		...
		stepsToFix: [
			...
			'Restart Sleepless Launcher after waiting',
	...
	},
	{
		...
		whatHappened:
			"Minecraft's authentication service is returning a server error, so Sleepless Launcher cannot finish signing you in right now.",
		stepsToFix: [
	...
	},
	{
		...
		stepsToFix: [
			...
			'Try signing in to Sleepless Launcher again',
		],
	},
	{
		matches: (message) =>
		...
		whatHappened:
			'Sleepless Launcher could not connect to a Microsoft, Xbox, or Minecraft service needed for sign-in. This is usually caused by a local network, DNS, proxy, firewall, hosts file, VPN, or antivirus issue.',
		stepsToFix: [
			'Restart Sleepless Launcher and try signing in again',
			'Check that your internet connection is working',
			'Allow Sleepless Launcher through your firewall, antivirus, proxy, VPN, and hosts file rules',
	...
	},
	{
		...
		whatHappened:
			'Xbox services rejected the request to authorize this account for Minecraft services, but did not return a specific account restriction that Sleepless Launcher recognizes.',
		stepsToFix: [
			'Sign in with the <a href="https://www.minecraft.net/en-us/download">official Minecraft Launcher</a>',
